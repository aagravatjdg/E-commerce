                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="h3 py-2">₹{{$data->shoes_price}}.00</p>
                            <p class="py-2">
                            ...
                            <form action="{{route('user-panel.store',auth()->user()->id)}}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            <li class="list-inline-item">Size :
                                                <input type="hidden" name="product-size" id="product-size" value="0">
                                            </li>
